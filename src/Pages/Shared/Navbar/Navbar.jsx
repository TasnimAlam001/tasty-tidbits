...
const Navbar = () => {
    ...
    return (
        <div className="">
            <div className="navbar fixed z-10 bg-black opacity-80 text-white max-w-screen-xl">
                ...
                <div className="navbar-end">
                    {
                        user ? <>
                            ...
                            <div className="flex-none">
                                {isAdmin || <div className="dropdown dropdown-end text-white font-bold">
                                    ...
                                    <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
                                        <div className="card-body">
                                            ...
                                            <span className="text-red-700 ">Total: <span className="font-bold">${total ? total : 0}</span></span>
                                            <Link to="/dashboard/myCart"><div className="card-actions">
                                                <button className="btn btn-primary btn-block">View cart</button>
                                            </div></Link>
                                        </div>
                                    </div>
                                </div>}
                                <div className="dropdown dropdown-end md:pt-4">
